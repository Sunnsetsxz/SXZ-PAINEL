...
speedLabel.Position = UDim2.new(0,0,0,90) speedLabel.Parent = main
...
speedVal.Position = UDim2.new(1,-70,0,90) speedVal.Parent = main
local bar = Instance.new("TextButton")
bar.Text = "" bar.Size = UDim2.new(1,-30,0,6) bar.Position = UDim2.new(0,15,0,115)
